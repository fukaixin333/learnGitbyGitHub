...
public class TK_ESYJ_CL01 extends NBaseTask{
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESYJ_CL01.class);

	public TK_ESYJ_CL01(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
