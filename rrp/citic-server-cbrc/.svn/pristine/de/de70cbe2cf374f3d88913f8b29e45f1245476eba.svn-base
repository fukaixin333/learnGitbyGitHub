...
public interface MM40_cxqq_cbrcMapper {
	...
	void insertBr40_cxqq_acct_dynamic_main(Br40_cxqq br40_cxqq);
	
	void delBr40_cxqq_acct_dynamic_main(Br40_cxqq br40_cxqq);
	
	void updateBr40_cxqq_acct_dynamic_main(Br40_cxqq_mx br40_cxqq_mx);
	...
	/** 通过证件号码获取客户信息 */
	CBRC_QueryRequest_Customer getPartyMsg_IdNum(Br40_cxqq_mx br40_cxqq_mx);
	
	/** 通过卡号获取客户信息 */
	CBRC_QueryRequest_Customer getPartyMsg_CardId(Br40_cxqq_mx br40_cxqq_mx);
	
	/** 通过账号获取客户信息 */
	CBRC_QueryRequest_Customer getPartyMsg_AcctId(Br40_cxqq_mx br40_cxqq_mx);
	
	/** 通过客户号获取个人账户信息 */
	List<CBRC_QueryRequest_Account> getLocalPrivateAcctInfo(String partyid);
	
	/** 通过客户号获取对公账户信息 */
	List<CBRC_QueryRequest_Account> getLocalPublicAcctInfo(String partyid);
	
	/** 插入客户信息 */
	void insertPartyInfo(CBRC_QueryRequest_Customer _queryRequest_party);
	
	/** 插入账户信息 */
	void insertAcctInfo(CBRC_QueryRequest_Account _queryRequest_acct);
	
	/** 插入强制措施信息 */
	void insertBr40_cxqq_back_acct_qzcs(Br40_cxqq_mx br40_cxqq_mx);
	
	void insertBr40_cxqq_back_acct_qzcs1(CBRC_QueryRequest_Measure queryRequest_Measure);
	
	/** 插入子账户信息 */
	void insertBr40_cxqq_back_acct_sub(Br40_cxqq_mx br40_cxqq_mx);
	
	void insertBr40_cxqq_back_acct_sub1(CBRC_QueryRequest_SubAccount queryRequest_SubAccount);
	
	/** 插入共享权优先权信息 */
	void insertBr40_cxqq_back_acct_ql(Br40_cxqq_mx br40_cxqq_mx);
	
	void insertBr40_cxqq_back_acct_ql1(CBRC_QueryRequest_Priority queryRequest_Priority);
	
	/** 获取交易流水列表 */
	List<CBRC_QueryRequest_Transaction> getAcct_TransList(Br40_cxqq_mx br40_cxqq_mx);
	
	/** 插入交易流水表 */
	public void insertBr40_cxqq_back_trans(List<CBRC_QueryRequest_Transaction> transactionList);
	
	/** 获取对公客户法人信息 */
	CBRC_QueryRequest_Customer getCorpPartyInfo(String partyid);
	
	CBRC_QueryRequest_Customer selectBr40_cxqq_back_party(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_Account> selectBr40_cxqq_back_acct(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_Measure> selectBr40_cxqq_back_acct_qzcs(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_Priority> selectBr40_cxqq_back_acct_ql(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_SubAccount> selectBr40_cxqq_back_acct_sub(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_Transaction> selectBr40_cxqq_back_trans(Br40_cxqq_mx br40_cxqq_mx);
	
	List<CBRC_QueryRequest_Transaction> selectBr40_cxqq_back_trans_dt(Br40_cxqq_back cxqqback);
	
	List<CBRC_ControlRequest_Record> selectBr40_cxqq_back_trans_dtList(Br40_cxqq_back cxqqback);
	...
	void updateBr40_cxqq_back_trans(CBRC_QueryRequest_Transaction tran);
	...
	void delBr40_receipt(CBRC_ReturnReceipt message);
	
	void insertBr40_receipt(CBRC_ReturnReceipt message);
	
	void updateBr40_cxqqStatus(CBRC_ReturnReceipt message);
	...
	List<CBRC_FeedbackRequest_Record> selectBr40_cxqq_hzwsList(Br40_cxqq br40_cxqq);
	...
	List<CBRC_RequestDhdj_City> getBr40_city_noList(MC21_task_fact mc21_task_fact);
	
	List<CBRC_RequestGzdj_AccountRule> getBr40_acct_ruleList(MC21_task_fact mc21_task_fact);
	
	List<CBRC_RequestWddj_Branch> getBr40_branch_regList(MC21_task_fact mc21_task_fact);
	...
	/** 通过客户号获取个人账户信息 */
	List<CBRC_QueryRequest_Account> getLocalCardInfo(String partyid);
	
	/** 通过账卡号账户信息 */
	List<CBRC_QueryRequest_Account> getLocalCardInfo_byAcctNo(Br40_cxqq_mx br40_cxqq_mx);
	
	/** 通过账卡号获取对公账户信息 */
	List<CBRC_QueryRequest_Account> getLocalPublicAcctInfo_byAcctNo(String cxzh);
	
	/** 通过客户号获取个人子账户信息 */
	List<CBRC_QueryRequest_SubAccount> getSubAccountList(String partyid);
	
	/** 通过客户号获取个人子账户信息 */
	List<CBRC_QueryRequest_SubAccount> getSubAccountList_byAcctNo(String cxzh);
	
	void insertBr40_cxqq_back_acct_qzcs2(CBRC_QueryRequest_Measure queryRequest_Measure);
	
	List<CBRC_QueryRequest_Measure> getBb11_freeze(Br40_cxqq_mx br40_cxqq_mx);
	...
	List<CBRC_QueryScanRequest_Record> selBr40_cxqq_back_pzList(Br40_cxqq br40_cxqq);
	
	List<CBRC_QueryScanRequest_Record> selBr40_cxqq_back_pz5List(Br40_cxqq br40_cxqq);
