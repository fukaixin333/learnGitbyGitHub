 ...
 */
@Data
public class CBRC_QueryResponse_Main implements Serializable {
	private static final long serialVersionUID = 7767150447351512885L;
	...
	public String toString() {
		return "CBRC_QueryResponse_Main [rwlsh=" + rwlsh + ", zzlx=" + zzlx + ", zzhm=" + zzhm + ", ztmc=" + ztmc + ", cxzh=" + cxzh + ", cxnr=" + cxnr + ", mxsdlx=" + mxsdlx + ", mxqssj=" + mxqssj
