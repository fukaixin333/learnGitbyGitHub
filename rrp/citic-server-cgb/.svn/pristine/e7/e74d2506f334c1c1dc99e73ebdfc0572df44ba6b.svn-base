 ...
 */
public class TK_ESJG_FK07 extends NBaseTask {
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_FK07.class);
	
	public TK_ESJG_FK07(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			//查询任务单数据并生成反馈报文
			fkBo.FeedBackQuery07(mc21_task_fact);
		} catch (Exception e) {
			isSucc = false;
			e.printStackTrace();
