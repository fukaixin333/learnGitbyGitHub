 ...
 * 
 * @author liuxuanfei
 * @date 2017年5月24日 下午8:19:59
 */
public class TK_ESJG_JS02 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_JS02.class);
	private CacheService cacheService;
	
	public TK_ESJG_JS02(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			Gdjg_ResponseLscx query_lscx = (Gdjg_ResponseLscx) CommonUtils.unmarshallDocument(Gdjg_ResponseLscx.class, flie_path,"GBK");
