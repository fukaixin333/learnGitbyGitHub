 ...
 */
public class TK_ESJG_CL06 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_CL06.class);
	private CacheService cacheService;
	
	public TK_ESJG_CL06(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			// 1.删除请求单下的数据
			clBo.delKzqqInfo06(mc21_task_fact);
			
			// 2.处理存款解冻登记接口
			String docno = clBo.handleQueryResponse06(mc21_task_fact);
