 ...
 */
public class TK_ESJG_JS08 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_JS08.class);
	private CacheService cacheService;
	
	public TK_ESJG_JS08(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			Gdjg_ResponseDtcx control_dtcx = (Gdjg_ResponseDtcx) CommonUtils.unmarshallDocument(Gdjg_ResponseDtcx.class, flie_path,"GBK");
			...
			//4.处理请求报文信息及插入task2
			jsBo.handleCxqqBw_Dtcx(control_dtcx, mc21_task_fact, taskmag);
