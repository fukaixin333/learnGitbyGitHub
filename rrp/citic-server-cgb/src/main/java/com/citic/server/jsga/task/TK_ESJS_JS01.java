...
public class TK_ESJS_JS01 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJS_JS01.class);
	private CacheService cacheService;
	
	public TK_ESJS_JS01(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			if (type.equals("SS05") || type.equals("SS06")) {
				bindingName = "binding_jsga_queryaccount_resp";
			} else {
				bindingName = "binding_jsga_query_resp";
			}
			...
			JSGA_QueryResponse query_cgcx = (JSGA_QueryResponse) CommonUtils.unmarshallUTF8Document(JSGA_QueryResponse.class, bindingName, flie_path);
			//3.删除请求单下的数据
