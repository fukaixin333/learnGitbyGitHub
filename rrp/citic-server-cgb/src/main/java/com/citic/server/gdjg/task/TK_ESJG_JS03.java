 ...
 * 
 * @author liuxuanfei
 * @date 2017年5月24日 下午8:22:32
 */
public class TK_ESJG_JS03 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_JS03.class);
	private CacheService cacheService;
	
	public TK_ESJG_JS03(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			Gdjg_ResponseJrcpcx query_jrcpcx = (Gdjg_ResponseJrcpcx) CommonUtils.unmarshallDocument(Gdjg_ResponseJrcpcx.class, flie_path,"GBK");
			//3.删除请求单下的数据
			Br57_cxqq br57_cxqq = new Br57_cxqq();
			br57_cxqq.setDocno(docno);//协作编号
			jsBo.delQureyResponse(br57_cxqq);
			//4.处理请求报文信息及插入task2
			jsBo.handleCxqqBw_Jrcpcx(query_jrcpcx, mc21_task_fact, taskmag);
