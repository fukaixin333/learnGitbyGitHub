...
public class TK_ESJS_CL02 extends NBaseTask{
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJS_CL02.class);

	public TK_ESJS_CL02(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
