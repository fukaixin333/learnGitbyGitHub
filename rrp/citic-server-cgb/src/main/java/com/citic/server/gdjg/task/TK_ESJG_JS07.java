...
public class TK_ESJG_JS07 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_JS07.class);
	private CacheService cacheService;
	
	
	public TK_ESJG_JS07(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			Gdjg_ResponseJjzfkz control_jjzf = (Gdjg_ResponseJjzfkz) CommonUtils.unmarshallDocument(Gdjg_ResponseJjzfkz.class, flie_path,"GBK");
			...
			//4.处理请求报文信息及插入task2
			jsBo.handleCxqqBw_Jjzfkz(control_jjzf, mc21_task_fact, taskmag);
