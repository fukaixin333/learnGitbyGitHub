...
public class TK_ESDX_JS09 extends NBaseTask {

	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESDX_JS09.class);
    ...
    private String root="";
	public TK_ESDX_JS09(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	      ...
	      try {
			...
			MC21_task_fact mc21_task_fact= this.getMC21_task_fact();
			  ...
			  Dx_KzqqBo kzqqBo=new Dx_KzqqBo(this.getAc());
			     //删除请求单号下的数据
			      kzqqBo.delKzqqBw_zf(transserialnumber);
				 ...
				 //2.解析请求报文
				        kzqqBo.analyKzqqBw(root, taskmag,"1",mc21_task_fact);
