 ...
 * 
 * @author Liu Xuanfei
 * @date 2016年4月13日 下午10:06:50
 */
public class QueryResponse100305 extends ResponseMessage {
	private static final long serialVersionUID = -7941533048874869010L;
	...
	/** 执行起始日期（yyyyMMddHHmmss） */
	private String interceptionStartTime;
	
	/** 执行截止日期（yyyyMMddHHmmss） */
	private String interceptionEndTime;
	...
	public String getTxCode() {
		return TxConstants.TXCODE_ACCOUNT_DYNAMIC;
	}
	...
	public String getInterceptionStartTime() {
		return interceptionStartTime;
	}
	
	public void setInterceptionStartTime(String interceptionStartTime) {
		this.interceptionStartTime = interceptionStartTime;
	}
	
	public String getInterceptionEndTime() {
		return interceptionEndTime;
	}
	
	public void setInterceptionEndTime(String interceptionEndTime) {
		this.interceptionEndTime = interceptionEndTime;
	}
