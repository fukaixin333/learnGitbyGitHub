...
public class Cache_DcountryDetail extends BaseCache {
	
	public Cache_DcountryDetail(ApplicationContext _ac, String cachename) {
		super(_ac, cachename);
	}
	...
	public Object getCacheByName() throws Exception {
		...
		ArrayList<Mp02_organ> list = common_Mapper.getMp02_country();
