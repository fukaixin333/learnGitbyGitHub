 ...
 * 
 * @author Liu Xuanfei
 * @date 2016年4月13日 下午4:21:32
 */
public class StoppayResponse100103 extends ResponseMessage {
	private static final long serialVersionUID = -5677417617848963350L;
	...
	public String getTxCode() {
		return TxConstants.TXCODE_STOPPAYMENT_RELIEVE;
	}
