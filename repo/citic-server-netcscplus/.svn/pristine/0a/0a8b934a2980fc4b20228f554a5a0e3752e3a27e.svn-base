...
public class Cache_DorganDetail extends BaseCache {
	
	public Cache_DorganDetail(ApplicationContext _ac, String cachename) {
		super(_ac, cachename);
	}
	...
	public Object getCacheByName() throws Exception {
		...
		ArrayList<Mp02_organ> list = common_Mapper.getMp02_organ();
