...
public class Cache_DcatpDetail extends BaseCache {
	
	public Cache_DcatpDetail(ApplicationContext _ac, String cachename) {
		super(_ac, cachename);
	}
	...
	public Object getCacheByName() throws Exception {
		...
		ArrayList<Mp02_organ> list = common_Mapper.getMp02_catp();
