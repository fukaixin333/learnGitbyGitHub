...
public class HtmlTest {
	...
	// <script></script>
	private static Pattern scriptPattern = Pattern.compile("(?:<script\\s*>|<script type=['\"]text/javascript['\"]\\s*>)(.*?)</script>", Pattern.DOTALL
	...
	public static String html2String(String path) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		String path = "../citic-server-netcscplus/src/main/resources/templates/gf/hzws_gf.html";
		String html = html2String(path);
		try {
			String result = compress(html);
			result.replace("/\n[|]*\r/g", "");
