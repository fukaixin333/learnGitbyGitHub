 ...
 */
public class TK_ESJG_FK05 extends NBaseTask {
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_FK05.class);
	
	public TK_ESJG_FK05(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
				...
				//查询任务单数据并生成反馈报文
				fkBo.FeedBackQuery05(mc21_task_fact);
		} catch (Exception e) {
			isSucc = false;
			e.printStackTrace();
