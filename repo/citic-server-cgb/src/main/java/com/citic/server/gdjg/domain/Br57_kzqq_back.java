...
import lombok.Data;
@Data
public class Br57_kzqq_back implements Serializable{
	private static final long serialVersionUID = -8431232142961971527L;
	...
	/** 对该控制任务的查询结果描述，成功或失败；01表示成功，02表示失败； */
	private String kzfkjg = "";
