...
public class TK_ESJS_FK01 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJS_FK01.class);
	
	public TK_ESJS_FK01(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
