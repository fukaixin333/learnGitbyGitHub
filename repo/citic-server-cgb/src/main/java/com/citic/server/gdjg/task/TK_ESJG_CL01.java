...
public class TK_ESJG_CL01 extends NBaseTask {
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_CL01.class);
	private CacheService cacheService;
	
	public TK_ESJG_CL01(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
