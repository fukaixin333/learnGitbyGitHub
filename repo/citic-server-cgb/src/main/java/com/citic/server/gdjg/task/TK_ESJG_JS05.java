 ...
 */
public class TK_ESJG_JS05 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_JS05.class);
	private CacheService cacheService;
	

	
	public TK_ESJG_JS05(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			Gdjg_ResponseCkdjkz control_ckdj = (Gdjg_ResponseCkdjkz) CommonUtils.unmarshallDocument(Gdjg_ResponseCkdjkz.class, flie_path,"GBK");
			...
			//4.处理请求报文信息及插入task2
			jsBo.handleCxqqBw_Ckdjkz(control_ckdj, mc21_task_fact, taskmag);
