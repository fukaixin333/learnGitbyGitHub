 ...
 */
public class TK_ESJG_CL08 extends NBaseTask{
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJG_CL08.class);
	private CacheService cacheService;
	
	public TK_ESJG_CL08(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			// 1.删除请求单下的数据
			clBo.delCxqqInfo08(mc21_task_fact);
			
			// 2.处理动态查询登记接口
			String docno = clBo.handleQueryResponse08(mc21_task_fact);
