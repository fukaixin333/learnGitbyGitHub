...
public class Br50_cxqq_mx implements Serializable{
                                              
/**
	 * 
	 */
	private static final long serialVersionUID = 9188347746428180040L;
...
6：按三证合一编号查询
7：交易明细查询
注：查询自然人时，只能按第 1、2 种方式查询；
查询法人时，只能按第 2、3、4、5 、6种方式查询
7:交易流水
 */
