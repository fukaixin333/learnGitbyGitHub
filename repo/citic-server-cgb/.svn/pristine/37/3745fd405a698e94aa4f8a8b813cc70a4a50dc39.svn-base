...
public class TK_ESJS_JS05 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJS_JS05.class);
	...
	public TK_ESJS_JS05(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			// 不同监管不同代码使用不同的绑定文件
			String bindingName = "binding_jsga_stoppayment_resp";
			...
			JSGA_StopPaymentResponse query = (JSGA_StopPaymentResponse) CommonUtils.unmarshallUTF8Document(JSGA_StopPaymentResponse.class, bindingName, flie_path);
