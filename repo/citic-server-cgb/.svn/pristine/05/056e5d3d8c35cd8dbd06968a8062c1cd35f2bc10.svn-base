...
public class TK_ESJJ_JS01 extends NBaseTask {

	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESJJ_JS01.class);
	private CacheService cacheService;
	
	
	
	public TK_ESJJ_JS01(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
	   ...
	   try {
				...
				Gdjc_ResponseCkcx query_ckcx = (Gdjc_ResponseCkcx) CommonUtils.unmarshallUTF8Document(Gdjc_ResponseCkcx.class, flie_path);
