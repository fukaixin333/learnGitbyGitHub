...
public class Kzqq_JSBo extends BaseBo {
	...
	public Kzqq_JSBo(ApplicationContext ac) {
		super(ac);
		br41_kzqqMapper = (MM41_kzqq_jsgaMapper) ac.getBean("MM41_kzqq_jsgaMapper");
	 ...
	 * @throws Exception
	 */
	public void insertBr41_kzqq_dj(JSGA_FreezeResponse query, MC21_task_fact mc21_task_fact) throws Exception {
		...
		//2. 插入请求主体信息、反馈主体信息
		List<JSGA_FreezeResponse_Account> dtList = query.getFreezeAccountList();
		for (JSGA_FreezeResponse_Account freeze : dtList) {
			...
			//2.2 插入反馈信息表
			JSGA_FreezeRequest_Record kzqq_dj = new JSGA_FreezeRequest_Record();
			...
			insertMc21TaskFact2(mc21_task_fact, "JSGA_" + tasktype);
		}
	 ...
	 * @throws Exception
	 */
	public void insertBr41_kzqq_zf(JSGA_StopPaymentResponse query, MC21_task_fact mc21_task_fact) throws Exception {
		JSGA_BasicInfo basicinfo = query.getBasicInfo();
		String qqdbs = basicinfo.getQqdbs();//请求单标识
		String mbjgdm = basicinfo.getMbjgdm(); //目标机构代码
		String tasktype = mc21_task_fact.getTasktype();//监管类别 
		...
		//2. 插入请求主体信息、反馈主体信息
		List<JSGA_StopPaymentResponse_Account> stoppayList = query.getStopPaymentAccountList();
		for (JSGA_StopPaymentResponse_Account stoppay : stoppayList) {
			...
			//2.2 插入反馈信息表
			JSGA_StopPaymentRequest_Recored kzqq_zf = new JSGA_StopPaymentRequest_Recored();
			...
			insertMc21TaskFact2(mc21_task_fact, "JSGA");
		}
	 ...
	 * @throws Exception
	 */
	public void insertBr41_kzqq(JSGA_BasicInfo basicinfo, JSGA_QueryPerson queryperson, String tasktype) throws Exception {
		/** 查询请求内容 */
		Br41_kzqq br41_kzqq = new Br41_kzqq();
