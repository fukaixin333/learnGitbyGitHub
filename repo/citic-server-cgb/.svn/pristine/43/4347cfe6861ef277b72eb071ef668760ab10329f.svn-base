...
public class TK_ESWH_FK02 extends NBaseTask {

	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESWH_FK02.class);

	
	
	
	public TK_ESWH_FK02(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
	   ...
	   try {
			   ...
			   String msgseq=mc21_task_fact.getBdhm();
				...
				//2.处理请求报文信息及插入task2
				  clBo.MakeMsgCxqqWH_ckrxx(msgseq);
