...
public class TK_ESYJ_CL04 extends NBaseTask{
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESYJ_CL04.class);

	public TK_ESYJ_CL04(ApplicationContext _ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
				...
				CBRC_FreezeResponse_Account cg_Freeze = br41_kzqqMapper.selectBr41_kzqq_djByVo(br41_kzqq);
