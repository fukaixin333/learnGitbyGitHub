...
public class TK_ESYJ_JS02 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESYJ_JS02.class);
	...
	public TK_ESYJ_JS02(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			// 不同监管不同代码使用不同的绑定文件
			String bindingName = "cbrc_control_resp" + tasktype;
			...
			CBRC_ControlResponse query = (CBRC_ControlResponse) CommonUtils.unmarshallUTF8Document(CBRC_ControlResponse.class, bindingName, flie_path);
