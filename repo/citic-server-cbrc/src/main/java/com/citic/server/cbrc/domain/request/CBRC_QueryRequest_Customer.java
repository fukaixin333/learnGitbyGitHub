...
public class CBRC_QueryRequest_Customer implements DictBean, Serializable {
	...
	/** 账户基本信息 */
	private List<CBRC_QueryRequest_Account> accountList;
	
	/** 账户强制措施信息 */
	private List<CBRC_QueryRequest_Measure> measureList;
	
	/** 账户共有权/优先权信息 */
	private List<CBRC_QueryRequest_Priority> prioritiesList;
	
	/** 关联子账户信息 */
	private List<CBRC_QueryRequest_SubAccount> subAccountList;
	
	/** 交易明細信息 */
	private List<CBRC_QueryRequest_Transaction> transactionList;
	...
	public String getGroupId() {
		return "CBRC_QUERYREQUEST_CUSTOMER";
	}
}
