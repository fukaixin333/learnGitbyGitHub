...
public class TK_ESYJ_JS04 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESYJ_JS04.class);
	...
	public TK_ESYJ_JS04(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
	...
	public boolean calTask() throws Exception {
		...
		try {
			...
			// 不同监管不同代码使用不同的绑定文件
			String bindingName = "cbrc_freeze_resp" + tasktype;
			...
			CBRC_FreezeResponse query = (CBRC_FreezeResponse) CommonUtils.unmarshallUTF8Document(CBRC_FreezeResponse.class, bindingName, flie_path);
