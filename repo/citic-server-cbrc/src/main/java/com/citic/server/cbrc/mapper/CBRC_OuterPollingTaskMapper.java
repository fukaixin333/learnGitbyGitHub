 ...
 * 
 * @author Liu Xuanfei
 * @date 2016年7月26日 下午2:15:36
 */
public interface CBRC_OuterPollingTaskMapper {
	...
	//////////////////////////////////////////////////////////////
	public List<Br40_cxqq> queryBr40_cxqq_acct_dynamic_main(@Param("tasktype") String tasktype, @Param("datatime") String datatime);
	
	public void updateBr40_cxqq_acct_dynamic_main(@Param("tasktype") String tasktype, @Param("aid") String aid, @Param("datatime") String datatime, @Param("pollinglock") String pollinglock);
	
	public void closeBr40_cxqq_acct_dynamic_main(String datatime);
