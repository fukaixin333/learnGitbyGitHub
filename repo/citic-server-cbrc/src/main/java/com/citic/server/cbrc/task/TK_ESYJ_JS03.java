...
public class TK_ESYJ_JS03 extends NBaseTask {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(TK_ESYJ_JS03.class);
	...
	public TK_ESYJ_JS03(ApplicationContext ac, MC21_task_fact mC21_task_fact) {
