 ...
 * 
 * @author Liu Xuanfei
 * @date 2016年7月6日 上午9:48:22
 */
@Data
public class CBRC_ControlRequest_Record implements Serializable {
	private static final long serialVersionUID = 8161679781858659898L;
